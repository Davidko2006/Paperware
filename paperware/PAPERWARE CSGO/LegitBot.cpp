...
void CLegitBot::SyncWeaponSettings()
{
	...
	if (GameUtils::IsPistol(pWeapon))
	{
		...
		Speed = Menu::Window.LegitBotTab.WeaponPistSpeed.GetValue() / 1000;
	...
	else if (GameUtils::IsSniper(pWeapon))
	{
		...
		Speed = Menu::Window.LegitBotTab.WeaponSnipSpeed.GetValue() / 1000;
	...
	{
		Speed = Menu::Window.LegitBotTab.WeaponMGSpeed.GetValue() / 1000;
	...
	{
		Speed = Menu::Window.LegitBotTab.WeaponShotgunSpeed.GetValue() / 1000;
	...
	else if (GameUtils::IsMP(pWeapon))
	{
		...
		Speed = Menu::Window.LegitBotTab.WeaponMpSpeed.GetValue() / 1000;
	...
	else
	{
		...
		Speed = Menu::Window.LegitBotTab.WeaponMainSpeed.GetValue() / 1000;
